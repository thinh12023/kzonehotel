...
router.post("/send_mail",async(req,res)=>{
    ...
    const transport =nodemailer.createTransport({
        service:"Gmail",      
        auth: {        
          user: 'thinh12023@gmail.com',
          pass: 'Thinh1099vn',            
        }
    })

    await transport.sendMail({
        form: "thinh12023@gmail.com",
        to: `${data.mails}`,
...
<![endif]-->
  ...
  <title></title>
    ...
    <style type="text/css">
      table, td { color: #000000; } a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_image_2 .v-src-width { width: 743px !important; } #u_content_image_2 .v-src-max-width { max-width: 64% !important; } }
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    <img align="center" border="0" src="cid:unique@kreata.ee" alt="Hero Image" title="Hero Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 54%;max-width: 313.2px;" width="313.2" class="v-src-width v-src-max-width"/>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #fdfdfd; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;">Th&ocirc;ng B&aacute;o Kh&aacute;ch H&agrave;ng</span></p>
  </div>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #fdfdfd; line-height: 170%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">${data.contents}</span></p>
  </div>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #d6d6d6; line-height: 170%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;">&copy;️ K-Zone Hotel.</p>
  </div>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #d6d6d6; line-height: 170%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;">185-187 Van Cao, Dang Giang Ward, Ngo Quyen District, Hai Phong city., Khu đ&ocirc; thị Ng&atilde; Năm - s&acirc;n bay C&aacute;t Bi, Hải Ph&ograve;ng, Việt Nam, 180000</p>
  </div>
...
<!--[if (mso)|(IE)]><table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center"><tr><![endif]-->
  ...
  <span style="padding:5px 10px;display:inline-block;color:#b6b6b6;font-family:arial,helvetica,sans-serif;font-size:14px">
    Contact : (+84) 203 3768555
  </span>
  ...
  <!--[if (mso)|(IE)]><td style="padding:5px 10px"><![endif]-->
    ...
    <a href="https://www.agoda.com/the-star-hotel/hotel/da-binh-vn.html?cid=1844104" target="_blank" style="padding:5px 10px;display:inline-block;color:#b6b6b6;font-family:arial,helvetica,sans-serif;font-size:14px;text-decoration:none" >
      Website : https://www.agoda.com/K-zone
    </a>
...
<div class="u-row-container" style="padding: 0px;background-color: #ffffff">
  <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #2dc234;">
    <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
      <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: #ffffff;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #2dc234;"><![endif]-->
